...
function setup() {
  ...
  Ron.scale = 0.8
  Ron.debug = false
  Ron.setCollider("rectangle",0,0,250,480)
...
function draw() {
  ...
  textSize(35)
  fill("white")
  text("Forest's Safety Level:"+score,50,50)
  ...
  if(gameState==="unsafe"){
    ...
    textSize(45)
    fill(255)
    text("Press Refresh Button or F5 on your keyboard to Play Again. All the Best!! ",5,350)
    fill ("yellow")
    textSize(33)
    text("Conservation of nature is related to the conservation of natural resources.",5,400)
    text("These include mainly water, sunlight, atmosphere, minerals, land, vegetation and animals.",5,450)
    text("Some resources are being used in these resources, due to which they are decreasing at high speed.",5,500)
    text("We should understand the importance of taking concrete steps to ensure nature's",5,550)
    text("protection and ecological balance.Nature's preservation shows the preservation of natural resources",5,600)
    text("without any human intervention. It is often seen that the importance of preserving natural resources",5,650)
    text("has been strongly emphasized as it is necessary to maintain a balanced environment on Earth",5,700)
  }
